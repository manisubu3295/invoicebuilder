...
const en = {
  ...
  quotations: {
    ...
    steps: [
      ...
      'Add line items: choose item type (Service or Delivery), fill in description, dates, and rate.',
      'Use the search box to pick from the Item Catalog for common service descriptions.',
      'Click Save. The quotation gets a unique number (e.g. AKB/SMM/Q001/2026).',
      'Open the quotation detail → click "Download PDF" to get a printable version.',
      'Click "Send Email" to email the PDF directly to the client.',
      'Once accepted, click "Convert to Invoice" to create the invoice.',
    ],
  },
  ...
  invoices: {
    nav: 'Invoices',
    title: 'Invoices',
    desc: 'Manage all invoices. Track payment status, download PDFs, send emails, and record payments.',
    steps: [
      ...
      'Click "Download PDF" to save a formatted invoice PDF.',
      'Click "Send Email" to email the invoice to the client.',
      'Click "Record Payment" to mark all or part of the invoice as paid.',
      'Status automatically changes to Paid once the full amount is recorded.',
  ...
  clients: {
    ...
    steps: [
      ...
      'The Client Code appears in document numbers: AKB/SMM/Q001/2026.',
  ...
  settings: {
    nav: 'Settings',
    title: 'Settings',
    desc: 'Configure company information, email credentials, and default payment terms. This data appears on all PDFs and emails.',
    steps: [
      'Go to Settings → fill in Company Name, Registration No., Address, Phone, and Email.',
      'Upload or set a Logo Text (3 letters shown in the sidebar logo badge).',
      ...
      'Configure Email Settings: SMTP Host, Port, Username, Password, and Sender Name.',
...
const ta = {
  ...
  quotations: {
    ...
    steps: [
      ...
      'வரிசை உருப்படிகள் சேர்க்கவும்: வகை (Service அல்லது Delivery), விளக்கம், தேதிகள், கட்டணம்.',
      'பொதுவான விளக்கங்களை தேட Item Catalog தேடல் பெட்டியைப் பயன்படுத்தவும்.',
      'Save கிளிக் செய்யவும். மேற்கோளுக்கு தனித்துவமான எண் வழங்கப்படும் (எ.கா. AKB/SMM/Q001/2026).',
      'மேற்கோள் விவரம் திறந்து "Download PDF" கிளிக் செய்யவும் — அச்சிட தயார்.',
      '"Send Email" கிளிக் செய்யவும் — வாடிக்கையாளரின் மின்னஞ்சலுக்கு PDF அனுப்பப்படும்.',
      'ஒப்புதல் கிடைத்தவுடன் "Convert to Invoice" கிளிக் செய்து விலைப்பட்டியல் உருவாக்கவும்.',
    ],
  },
  ...
  invoices: {
    ...
    desc: 'அனைத்து விலைப்பட்டியல்களையும் நிர்வகிக்கவும். கட்டண நிலையை கண்காணிக்கவும், PDF பதிவிறக்கவும், மின்னஞ்சல் அனுப்பவும்.',
    steps: [
      ...
      '"Download PDF" — வடிவமைக்கப்பட்ட PDF சேமிக்கவும்.',
      '"Send Email" — வாடிக்கையாளரின் மின்னஞ்சலுக்கு விலைப்பட்டியல் அனுப்பவும்.',
      '"Record Payment" — முழு அல்லது பகுதி தொகை செலுத்தியதாக பதிவு செய்யவும்.',
      'முழுத் தொகையும் பதிவானதும் நிலை தானாக "Paid" ஆக மாறும்.',
  ...
  clients: {
    ...
    steps: [
      ...
      'வாடிக்கையாளர் குறியீடு ஆவண எண்களில் தோன்றும்: AKB/SMM/Q001/2026.',
  ...
  settings: {
    ...
    desc: 'நிறுவனத் தகவல், மின்னஞ்சல் சான்றுகள் மற்றும் இயல்புநிலை கட்டண விதிமுறைகளை உள்ளமைக்கவும். இந்த தகவல் அனைத்து PDF மற்றும் மின்னஞ்சல்களிலும் தோன்றும்.',
    steps: [
      'Settings → நிறுவனத்தின் பெயர், பதிவு எண், முகவரி, தொலைபேசி, மின்னஞ்சல் உள்ளிடவும்.',
      'Logo Text (3 எழுத்துகள்) அமைக்கவும் — இது பக்கப்பட்டி லோகோவில் தோன்றும்.',
      ...
      'மின்னஞ்சல் அமைப்புகள்: SMTP Host, Port, Username, Password, அனுப்பியவர் பெயர்.',
      'Signatory Name — PDF ஆவணங்களில் அங்கீகரிக்கப்பட்ட கையொப்பத்தாரர் பெயர்.',
      '"Save Settings" கிளிக் செய்து அனைத்து மாற்றங்களும் சேமிக்கவும்.',
    ],
  },
