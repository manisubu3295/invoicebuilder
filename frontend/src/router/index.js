...
const routes = [
  { path: '/login', component: () => import('../views/auth/Login.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'rate-units', component: () => import('../views/rateUnits/RateUnitsView.vue'), meta: { roles: ['admin'] } },
      { path: 'guide', component: () => import('../views/guide/HelpGuide.vue') },
      { path: 'drivers/map', component: () => import('../views/drivers/DriverMap.vue'), meta: { roles: ['admin', 'staff'] } },
      { path: 'expenses', component: () => import('../views/expenses/ExpenseList.vue') },
      { path: 'expenses/new', component: () => import('../views/expenses/ExpenseForm.vue') },
      { path: 'expenses/:id/edit', component: () => import('../views/expenses/ExpenseForm.vue') },
    ],
  },
