...
export const quotationsApi = {
  ...
  getNextNumber: (clientId) => api.get('/quotations/next-number', { params: { clientId } }),
...
export const reportsApi = {
  ...
  soa: (clientId, params) => api.get(`/reports/soa/${clientId}`, { params }),
  soaPdf: (clientId, params) => api.get(`/reports/soa/${clientId}/pdf`, { params, responseType: 'blob' }),
